...
bot_token = '6766986059:AAHRO3IowM1MVpzw0cpCdfuqrxJcM6tQ09c'  # Replace with your bot token
...
ADMIN_ID = 1790665950  # Replace with the actual admin's user ID
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @SOUL_LEGIT: {ADMIN_ID}")
